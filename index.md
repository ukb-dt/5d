...
## Overview
This five-day journey invites WHO [colleagues](https://ukb-dt.github.io/who/) to **see health systems as living grammars of change** — structures that encode, compress, and regenerate meaning.  
...
- What makes a health system *trusted*?
- How does knowledge integrate back into community and policy?
- Where are the sacred bottlenecks of compression — moments where data becomes wisdom?
...
Activities:
- Teams map one real WHO initiative through the five layers.
- Identify one point of signal loss, and design a regenerative loop.
- Collective reflection: *What surprised you about your column’s dependencies?*
...
## Why It Works
- **Structure → Function → Dynamics → Integration → Meaning** mirrors how both minds and health systems learn.  
- **MathJax stays optional:** The calculus lives as metaphor until curiosity invites it forward.  
- **“Choose your selfie”** turns an abstract model into a relational icebreaker.  
- **Universal grammar:** The IMRAD cycle (Intro, Methods, Results, Discussion) maps onto the same pentad — showing AI and health science as twin grammars.
